...
public class AlchemistTableBlock extends WorkstationBlock {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, ModBlocks.ALCHEMIST_TABLE_BLOCK_ENTITY, AlchemistTableBlockEntity::tick);
    }
    ...
    static {
        ...
        SHAPE = Block.createCuboidShape(0.0D, 1.0D, 0.0D, 16.0D, 15.0D, 16.0D);
    }
}
