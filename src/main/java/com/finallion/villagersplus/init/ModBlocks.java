...
public class ModBlocks {
    ...
    public static void registerBlocks() {
        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "oceanographer_table"), OCEANOGRAPHER_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "oceanographer_table"), new BlockItem(OCEANOGRAPHER_TABLE_BLOCK, new FabricItemSettings()));

        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "alchemist_table"), ALCHEMIST_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "alchemist_table"), new BlockItem(ALCHEMIST_TABLE_BLOCK, new FabricItemSettings()));

        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "occultist_table"), OCCULTIST_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "occultist_table"), new BlockItem(OCCULTIST_TABLE_BLOCK, new FabricItemSettings()));

        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "oak_horticulturist_table"), OAK_HORTICULTURIST_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "oak_horticulturist_table"), new BlockItem(OAK_HORTICULTURIST_TABLE_BLOCK, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "dark_oak_horticulturist_table"), DARK_OAK_HORTICULTURIST_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "dark_oak_horticulturist_table"), new BlockItem(DARK_OAK_HORTICULTURIST_TABLE_BLOCK, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "acacia_horticulturist_table"), ACACIA_HORTICULTURIST_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "acacia_horticulturist_table"), new BlockItem(ACACIA_HORTICULTURIST_TABLE_BLOCK, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "birch_horticulturist_table"), BIRCH_HORTICULTURIST_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "birch_horticulturist_table"), new BlockItem(BIRCH_HORTICULTURIST_TABLE_BLOCK, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "jungle_horticulturist_table"), JUNGLE_HORTICULTURIST_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "jungle_horticulturist_table"), new BlockItem(JUNGLE_HORTICULTURIST_TABLE_BLOCK, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "spruce_horticulturist_table"), SPRUCE_HORTICULTURIST_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "spruce_horticulturist_table"), new BlockItem(SPRUCE_HORTICULTURIST_TABLE_BLOCK, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "mangrove_horticulturist_table"), MANGROVE_HORTICULTURIST_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "mangrove_horticulturist_table"), new BlockItem(MANGROVE_HORTICULTURIST_TABLE_BLOCK, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "crimson_horticulturist_table"), CRIMSON_HORTICULTURIST_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "crimson_horticulturist_table"), new BlockItem(CRIMSON_HORTICULTURIST_TABLE_BLOCK, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(VillagersPlus.MOD_ID, "warped_horticulturist_table"), WARPED_HORTICULTURIST_TABLE_BLOCK);
        Registry.register(Registries.ITEM, new Identifier(VillagersPlus.MOD_ID, "warped_horticulturist_table"), new BlockItem(WARPED_HORTICULTURIST_TABLE_BLOCK, new FabricItemSettings()));
    }
}
